...
## Идея: создать приложение способное извлекать данные из истории telegram каналов, чатов, других источников и способное формулировать свои ответы на их основе 
