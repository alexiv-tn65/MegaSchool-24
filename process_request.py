...
print("\nПривет! Я ИИ ассистент, готов ответить на ваши вопросы.")
...
Ты ассистент, ты должен отвечать на вопрос. Старайся отвечать коротко, не повторяй вопрос который тебе задали.
