...
template = """Даны История переписки и вопрос, перефразируй вопрос, чтобы он стал Самостоятельный вопрос.
Вопрос о том, что было в переписке, История переписки содержит все сообщения которыми обменивались люди
